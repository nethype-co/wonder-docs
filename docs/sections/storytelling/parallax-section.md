...
* **Maximum rotation:** Adjust the degree of rotation for the images.
* **First image:** Upload or select the first image for the parallax effect.
* **First picture link:** Add a link for the first image.
* **Second image:** Upload or select the second image for the parallax effect.
* **Second picture link:** Add a link for the second image.
...
* **Mobile screen text alignment:** Choose the alignment of the text on the banner for mobile screens (options: Top, Center, Bottom, Left, Center, Right).
