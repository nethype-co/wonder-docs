...
<DocVideo src="/img/docs/timeline.webm" autoPlay playsInline muted loop style={{width: "100%", marginBottom: "20px", borderRadius: "8px"}} />
...
<DocVideo src="/img/docs/timeline-guide.webm" controls playsInline muted loop style={{width: "100%", marginBottom: "20px", borderRadius: "8px"}} />