---
title: "Image Banner (Image banner for transparent header)"
sidebar_label: "Image Banner (Image banner for transparent header)"
---
...
![](/img/docs/image-banner-desktop.png)

## Mobile view example

<img src="/img/docs/image-banner-mobile.png" style={{width: "100%"}} />
...
<DocVideo src="/img/docs/image-banner.webm" controls playsInline muted style={{width: "100%", marginBottom: "20px", borderRadius: "8px"}} />
