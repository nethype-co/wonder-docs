...
* **Enable animation:** Option to enable animation for the announcement bar.
* **Animation speed:** Set the speed of the animation (Slow, Normal, Fast).
* **Enable users to close the bar:** Allows users to close the announcement bar.
