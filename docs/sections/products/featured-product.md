...
* **Mobile Image** : Adjust the size of the product image for mobile viewers. Select 'Normal' for a full-scale display or 'Small' for a more compact presentation, optimizing the browsing experience on handheld devices.
