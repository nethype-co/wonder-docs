---
title: "Email Signup"
sidebar_label: "Email Signup"
---

import SectionMeta from '@site/src/components/SectionMeta';
import DocVideo from '@site/src/components/DocVideo';

## What is the Email Signup section?

<SectionMeta version="v1.0.0" />

The Email Signup section displays a clean, minimal newsletter subscription form, allowing customers to sign up for emails directly from the page. It is ideal for growing your mailing list and keeping customers informed about new collections, promotions, and exclusive offers.

<img src="/img/docs/signup-form.png" />
...
## How to set up section Signup Form?

<DocVideo src="/img/docs/email-signup.webm" controls playsInline muted loop style={{width: "100%", marginBottom: "20px", borderRadius: "8px"}} />
