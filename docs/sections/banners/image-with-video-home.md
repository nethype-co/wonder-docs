...
![](/img/docs/image-with-video-home-settings.jpeg)
...
- **Content over:** Choose whether the content displays over the **Image** or **Video**.

:::note
Works only with Shopify-hosted videos on desktop resolution. For YouTube/Vimeo, select 'Image'.
:::
...
![](/img/docs/image-with-video-heading-block.jpeg)

### Customize Text block

![](/img/docs/image-with-video-text-block.jpeg)

### Customize Button block

![](/img/docs/image-with-video-button-block.jpeg)

### Mobile view

![](/img/docs/image-with-video-home-mobile-view.jpeg)
