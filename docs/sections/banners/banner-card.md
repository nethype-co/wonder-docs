...
* **Horizontal text position:** Set the alignment of text within the banner on desktop (**left, center**, or r**ight**).
...
* **Horizontal text position:** Set the alignment of text within the banner on mobile (**left, center**, or r**ight**).
