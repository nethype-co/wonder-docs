...
- **A Shopify-hosted video:** Select a video to display as the banner background on large screens.
...
### Optimization
- **High-priority image loading:** Enable this option to load the banner image with high priority.

---

## How to set up Section Image Banner

<DocVideo src="/img/docs/image-banner-main.webm" controls  muted  style={{width: "100%", marginBottom: "20px", borderRadius: "8px"}} />
...
<DocVideo src="/img/docs/main-banner-blocks.webm" controls muted style={{width: "100%", marginBottom: "20px", borderRadius: "8px"}} />