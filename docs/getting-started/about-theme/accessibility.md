...
Ensure sufficient contrast between text and background colors. Use a [contrast checker tool](https://webaim.org/resources/contrastchecker/) to verify your color combinations meet at least **WCAG AA level** (4.5:1 for normal text, 3:1 for large text).
...
- Run an automated audit with [Google Lighthouse](https://developer.chrome.com/docs/lighthouse/) or [WAVE](https://wave.webaim.org/)
