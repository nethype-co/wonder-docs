...
3. **Open the Edit Code Section:** In the left sidebar, click the dropdown menu, and select "Edit code."
4. **Exploring the Edit Code Page:** The "Edit code" page offers a directory of theme files and an online code editor.
